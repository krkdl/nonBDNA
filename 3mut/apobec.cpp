...
int   XROSOMA::creatTCx( char *pSelBuff )
{
    ...
    printf( "X%d.creatTCx: RTsiz:RTin TCx:TCin-> %ld : %ld\t%ld : %ld\n",
           chrNum, RTsize, noNucInMuZon, TCXsize, noTCxInMuZon);
    ...
    fprintf(tsld, "RTsize=%ld inMuZo=%ld\tTCXsiz=%ld (of %ld) inMuZo=%ld\n",
            RTsize, noNucInMuZon, TCXsize, TCxMemSize, noTCxInMuZon);
#endif
